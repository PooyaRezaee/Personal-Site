...
class SettingForms(FlaskForm):
    FullName = StringField(render_kw={"placeholder":"Your Name","class":"w-100 p-1 mb-4"})
    profile_image = FileField(render_kw={"class":"w-100 p-1 mb-4 border-0"})
    background_image = FileField(render_kw={"class":"w-100 p-1 mb-4 border-0"})
    AboutME = TextAreaField(render_kw={"placeholder":"About You","class":"w-100 p-1 mb-4"})
